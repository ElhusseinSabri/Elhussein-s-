...
$sql1 =" SELECT day as dpd ,payments as dpp ,reserve_id as dpr FROM dailypayment WHERE day BETWEEN '$resdate1' AND '$resdate2'";
                    ...
                    <table border="1" cellpadding="1" cellspacing="1" class="tbl2">
                        <tr>
                            ...
                            <th scope="col" class="tbl2c">Total payment</th>
                             <th scope="col" class="tbl2c">Reserve ID</th>
